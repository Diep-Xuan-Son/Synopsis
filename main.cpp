...
SEG_ROJO_AZUL 		:= dejar solo los objsetos rojos (true) o los objetos azules (false)
...
#define FONDO_NOMBRE "FONDO11.jpg"
...
// videos
#define ENTRADA_NOMBRE "video11.mp4"
//#define ENTRADA_NOMBRE "video_casa.mp4"
#define SALIDA_NOMBRE "salida11.mp4"
#define RATIO 2
//#define FPS 30
//
...
//	char fileName[100] = argv[1];
	...
	Size S 			= Size((int) stream.get(cv::CAP_PROP_FRAME_WIDTH)/RATIO, (int) stream.get(cv::CAP_PROP_FRAME_HEIGHT)/RATIO);
	int codec 		= static_cast<int>(stream.get(cv::CAP_PROP_FOURCC));
	double framenum = stream.get(cv::CAP_PROP_FPS);
